...
using LIB.API.Persistence.Services;
    ...
    public static partial class PersistenceServiceRegistrtion
    {
        public static IServiceCollection ConfigurePersistenceService(this IServiceCollection services, IConfiguration configuration)
        {
           ...
           services.AddScoped<IAirlinesOrderService, AirlinesOrderService>();
            ...
            services.AddScoped<ICoreTransactionRepository, CoreTransactionRepository>();

            // Register the background service
            services.AddHostedService<ETCoreTransactionTaskService>();
