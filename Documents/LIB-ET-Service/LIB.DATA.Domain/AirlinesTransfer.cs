...
namespace LIB.API.Domain
{
    public class AirlinesTransfer
    {
        ...
        public int? Id { get; set; } // Primary Key (nullable)
        ...
        public string? DAccountName { get; set; }  // Debtor Account Number
        public string? CAccountNo { get; set; }  // Creditor Account Number
        public string? DAccountBranch { get; set; } // Debtor Account Branch
        ...
        public bool? IsSuccessful { get; set; } // Make this nullable if it can be null
        public string? updatedBy { get; set; }  // Creditor Account Number
        public string? approvedBy { get; set; } // Debtor Account Branch
