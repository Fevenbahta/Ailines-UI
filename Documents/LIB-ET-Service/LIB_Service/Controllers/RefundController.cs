...
using LIB.API.Application.Contracts.Persistent;
    ...
    namespace LIB.API.Controllers
    {
        ...
        public RefundController(IRefundRepository refundRepository, ICoreTransactionRepository coreTransactionRepository)
            {
        ...
        public async Task<IActionResult> ProcessRefund([FromBody] RefundRequest request)
        {
            try
            {
                ...
                return Ok(new
                {
                    ...
                    ResponseCodeDescription = isRefundProcessed ? "Successfully Accepted" : "Refund processing failed due to an error",
